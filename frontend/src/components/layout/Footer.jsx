        ...
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <div className="footer-links">
              ...
              <Link to="/add-data" className="footer-link">Add Data</Link>
              <Link to="/history" className="footer-link">Prediction History</Link>
          ...
          <div className="footer-section">
            ...
            <div className="footer-links">
              ...
              <a href="#" className="footer-link">Best Practices</a>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-content">
            <div className="copyright">
              <p>&copy; {currentYear} ReturnPredict. All rights reserved.</p>
            </div>
